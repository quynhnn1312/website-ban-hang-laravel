                                                ...
                                                <div class="two-product">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="product-img">
                                                            <a href="{{ route('get.detail.product', [$pro->pro_slug, $pro->id]) }}">
                                                            ...
                                                            <div class="action-zoom">
                                                                <div class="add-to-cart">
                                                                    <a href="{{ route('get.detail.product', [$pro->pro_slug, $pro->id]) }}" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="actions">
                                                            ...
                                                            <div class="price-box">
                                                                <span class="new-price">{{ number_format($pro->pro_price,0,',','.') }}đ</span>
                                                            </div>
                                                        </div>
                                                        <div class="product-content">
                                                            <h2 class="product-name"><a href="{{ route('get.detail.product', [$pro->pro_slug, $pro->id]) }}">{{ $pro->name }}</a></h2>
                                                            <p>{{ $pro->pro_name }}</p>
                                                        </div>
                                                    </div>
                                                    <!-- single-product end -->
